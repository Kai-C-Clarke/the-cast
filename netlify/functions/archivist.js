...
const FILE_INDEX = [
  ...
  { keywords: ['ply repair','plywood repair','ply patch','ply scarf','ply skin','rib grommet','leading edge repair','scarf ply','12:1','ply panel','skin repair','hole','skin hole','hole in skin','puncture'], path: 'BGA_Standard_Repairs/section3_ch33_ply_repairs.txt', label: 'BGA Standard Repairs — Section 3 Chapter 3.3 (Ply Repairs)' },
  ...
  { keywords: ['wood','timber','ply','plywood','spruce','spar','stringer','grain','moisture','scarf','joint','aerodux','resorcinol','casein','repair','section 3','hole','hole repair','fuselage','fuselage repair','fuselage hole','damage','damaged'], path: 'BGA_Standard_Repairs/section3_text.txt', label: 'BGA Standard Repairs — Section 3 (Wood Repairs)' },
