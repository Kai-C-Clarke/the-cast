...
const FILE_INDEX = [
  ...
  { keywords: ['metal fitting','rivet','bolt','hinge','pin','clevis','cable','swaged','control cable','thread','turnbuckle','skid','armour plate','undercarriage'], path: 'BGA_Standard_Repairs/section4_ch43_metal_fittings_cables.txt', label: 'BGA Standard Repairs — Section 4 Chapter 4.3 (Metal Fittings and Cables)' },
